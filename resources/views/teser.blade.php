            ...
            <div class="row">
                <div class="col-sm-5 offset-1">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="name">RÉÉCRIVEZ VOTRE MOT DE PASSE</label>
                                <input type="text" class="form-control form-control-teser" id="name" name="name" required>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-5">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="name">ENTREZ L'EMAIL DE VOTRE CHEF D'ÉQUIPE</label>
                                <input type="text" class="form-control form-control-teser" id="name" name="name" required>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="col-sm-12 text-right">
                                                <div class="form-check">
                                                    <label class="form-check-label-teser">J'AI VU CE MESSAGE
                                                        <input class="form-checkbox-teser" type="checkbox" value="">
